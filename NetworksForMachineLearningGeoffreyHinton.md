...
- if we change the weights in proportion to the derivative, it's equivalent to doing steepest descent on the error surface[inse]
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUxMzY3NDQ4MSwtMTU2MzUxNTAwLDI2Nj
